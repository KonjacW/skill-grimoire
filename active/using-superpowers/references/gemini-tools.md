...
Skills dispatch with `Subagent (generic):` and either reference a prompt-template file (e.g., `requesting-code-review`'s `./code-reviewer.md`) or supply an inline prompt. On Gemini CLI:
